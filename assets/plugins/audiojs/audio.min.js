(function(h, o, g) {
	...
	g[h] = {
		...
		flashSource: '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="$1" width="1" height="1" name="$1" style="position: absolute; left: -1px;"><param name="movie" value="$2?playerInstance=' + 
			h + '.instances[\'$1\']&datetime=$3"><param name="allowscriptaccess" value="always"><embed name="$1" src="$2?playerInstance=' +
		...
		settings: {
			...
			createPlayer: {
				markup: '<div class="songs-left"><p class="gaosongs-name">久久真爱<img src="../assets/imgs/turelove99/gaossong-icon.png" alt=""></p><p class="gaosongs-write">制作人：高晓松</p></div><div class="songs-mid"><img src="../assets/imgs/turelove99/rotary-btn.png" alt=""></div><div class="songs-right"><div class="play-pause"><p class="play"></p><p class="pause"></p><p class="loading"></p><p class="error"></p></div><div class="time"><em class="played">00:00</em>/<strong class="duration">00:00</strong></div><div class="scrubber"><div class="progress"></div><div class="loaded"></div></div><div class="error-message"></div></div>',
			...
			css: '.audiojs audio { position: absolute; left: -1px; } .audiojs { position: relative; width: 100%; height: 75px; background: url(../assets/imgs/turelove99/gaossong-bg.png) no-repeat; background-position: center center; background-size: 100% 100%; font-size: 12px; margin: 16px 0; }.audiojs .play-pause { width: 30px; height: 30px; margin: 0px 8px; overflow: hidden; } .songs-right p { display: none; width: 30px; height: 30px; margin: 0px; cursor: pointer; } .audiojs .play { display: block; } .audiojs .scrubber { position: relative; float: left; width: 100px; background: #6d4c21; height: 12px; margin: 8px auto 0 10px; overflow: hidden; border: 1px solid #5e421c; border-radius: 6px; } .audiojs .progress { position: absolute; top: 0; left: 0; height: 12px; width: 0px; background: #dfb681; z-index: 1; border-radius: 6px; } .audiojs .loaded { position: absolute; top: 0px; left: 0px; height: 12px; width: 0px; background: #5e421c; border-radius: 6px; } .audiojs .time { position: absolute; top: 15px; right: -8px; color: #8e5506; } .audiojs .time em { color: #8e5506; font-style: normal; } .audiojs .time strong { font-weight: normal; } .audiojs .error-message { float: left; display: none; margin: 0px 10px; height: 36px; width: 400px; overflow: hidden; line-height: 36px; white-space: nowrap; color: #fff; text-overflow: ellipsis; -o-text-overflow: ellipsis; -icab-text-overflow: ellipsis; -khtml-text-overflow: ellipsis; -moz-text-overflow: ellipsis; -webkit-text-overflow: ellipsis; } .audiojs .error-message a { color: #eee; text-decoration: none; padding-bottom: 1px; border-bottom: 1px solid #999; white-space: wrap; } .audiojs .play { background: url(../assets/imgs/turelove99/gaos-play-icon.png) no-repeat; background-size: contain; } .audiojs .loading { background: url("$1") -2px -31px no-repeat; } .audiojs .error { background: url("$1") -2px -61px no-repeat; } .audiojs .pause { background: url(../assets/imgs/turelove99/gaos-pause-icon.png) no-repeat; background-size: contain; } .playing .play, .playing .loading, .playing .error { display: none; } .playing .pause { display: block; } .loading .play, .loading .pause, .loading .error { display: none; } .loading .loading { display: block; } .error .time, .error .play, .error .pause, .error .scrubber, .error .loading { display: none; } .error .error { display: block; } .error .play-pause p { cursor: auto; } .error .error-message { display: block; }',
			trackEnded: function() {},
			flashError: function() {
			...
			if(a.settings.createPlayer) {
				...
				g[h].events.addListener(d, "click", function() {
					...
					if($('audio').get(0).paused){
						$('.songs-mid').removeClass('play-rotate');
					} else {
						$('.songs-mid').addClass('play-rotate');
					}
